...
The process has taught me a lot, so I thought I'd give a quick overview of some of the things I've learnt,
as well as hint at some future blog posts.
Feel free to let me know which you'd like to see first.

## Contents
- [Project strategy](#project-strategy)
- [Version Control](#version-Control)
- [Process of writing code](#process-of-writing-code)
- [Invalid array indexes](#invalid-array-indexes)
- [Enums](#enums)
- [Macros](#macros)
- [Saving and loading binary files](#saving-and-loading-binary-files)
- [Linear memory undo](#linear-memory-undo)
- [Geometry/maths](#geometrymaths)
- [Complex state-based user input](#complex-state-based-user-input)
- [UI Feedback](#ui-feedback)
- [Multiple monitors](#multiple-monitors)
- [Resources](#resources)
- [Common/notable bugs](#commonnotable-bugs)
...
I was doing some queries into point arrays and started using 0 as an invalid index.
This meant that I could do standard boolean conditionals such as `if(SnapPointIndex) { DoThingWithSnappedPoint(SnapPointIndex); }`.
It also meant that I had to keep the first point free.
I now have a mix of 0-index and 1-index arrays, which has lead to a few off-by-one errors, and just adds unnecessary cognitive overhead.
...
- Lerp (interpolate) between states to make clear both what changed and how it did so.
    ...
    - There are a bunch of fancier motion curves that you can use.
        ...
        ```
        - See http://easings.net/ for other examples.
        There is C code for these here: https://github.com/warrenm/AHEasing/blob/master/AHEasing/easing.c
